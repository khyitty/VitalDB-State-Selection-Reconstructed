...
PRODUCTION_SOURCES = (
    ...
    ROOT / "src" / "vitaldb_state_selection" / "data" / "access_policy.py",
    ...
    ROOT / "scripts" / "freeze_protocol_v1_2_cohort.py",
    ROOT / "scripts" / "freeze_protocol_v1_3_design.py",
    ROOT / "scripts" / "run_subject_linkage_audit.py",
